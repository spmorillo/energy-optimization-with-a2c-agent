...
if __name__ == '__main__':
    ...
    summersim.fog_model.define_p_unit_config(p_unit_id='air_units',  # The ID must be unique
                                             ...
                                             pwr_model_config={'file_path_to_model_and_scalers': '../models/pu_power/rx580_power_model/air_model/power_model_rx580'})
    ...
    summersim.fog_model.define_p_unit_config(p_unit_id='immersion_units',  # The ID must be unique
                                             ...
                                             pwr_model_config={'file_path_to_model_and_scalers': '../models/pu_power/rx580_power_model/immersion_model/power_model_rx570'})

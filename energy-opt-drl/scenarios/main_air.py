...
from samples.models.pu_power.rx580_power_model.air_model.rx580_power_model import Rx580PowerModel
from samples.summersim_2020.rl.mercury_agents.rl_agent_strategy_v2_cooling import SDNRLAgentStrategy
from samples.models.rack.air_cooling_system import AirCoolingSystem

# change 25 -> 20 per service to compare
...
if __name__ == '__main__':
    ...
    summersim.fog_model.add_custom_rack_node_power_model('air_model', AirCoolingSystem)
    ...
    summersim.fog_model.define_p_unit_config(p_unit_id='Rx580',  # The ID must be unique
                                             ...
                                             pwr_model_config={'file_path_to_model_and_scalers': '../models/pu_power/rx580_power_model/air_model/power_model_rx580'})  # Processing Unit Power Consumption model
    ...
    summersim.fog_model.define_edc_rack_type(rack_id='air',
                                             pwr_model_name='air_model',
    ...
    edc_racks_map = {'rack_1': ('air', ['Rx580'] * gpus_per_edc)}
